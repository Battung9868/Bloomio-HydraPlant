...
//  Green Timer
//
//  Created by Ashot Kirakosyan on 05.11.25.
//
...
// MARK: - Конфиг сервера
enum RemoteConfig {
    static let endpointURL = "https://blomiohydra.com/lander/new-ios-server/server.php"
    static let accessKey   = "pHgZtKfXwR3mLn9"
